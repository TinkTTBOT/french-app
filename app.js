...
const practiceTasks = [
  // A1
  { level: 'A1', topic: 'Chào hỏi', prompt: 'Xin chào, bạn khỏe không?', answer: 'Bonjour, ça va ?' },
  { level: 'A1', topic: 'Chào hỏi', prompt: 'Tôi tên là Nam.', answer: 'Je m’appelle Nam.' },
  { level: 'A1', topic: 'Gia đình', prompt: 'Đây là gia đình tôi.', answer: 'Voici ma famille.' },
  { level: 'A1', topic: 'Học tập', prompt: 'Chúng tôi đi đến trường.', answer: 'Nous allons à l’école.' },
  { level: 'A1', topic: 'Ẩm thực', prompt: 'Tôi muốn cà phê.', answer: 'Je veux un café.' },
  { level: 'A1', topic: 'Ẩm thực', prompt: 'Anh ấy đang ăn táo.', answer: 'Il mange une pomme.' },
  { level: 'A1', topic: 'Mua sắm', prompt: 'Cái này bao nhiêu tiền?', answer: 'C’est combien ?' },
  { level: 'A1', topic: 'Cảm xúc', prompt: 'Tôi rất vui.', answer: 'Je suis très content.' },
  ...
  { level: 'A2', topic: 'Giờ giấc', prompt: 'Bây giờ là mấy giờ?', answer: 'Quelle heure est-il maintenant ?' },
  { level: 'A2', topic: 'Giao tiếp', prompt: 'Bạn có thể lặp lại không?', answer: 'Pouvez-vous répéter ?' },
  { level: 'A2', topic: 'Mua sắm', prompt: 'Tôi cần cỡ lớn.', answer: 'J’ai besoin d’une taille L.' },
  { level: 'A2', topic: 'Sức khỏe', prompt: 'Tôi bị đau đầu.', answer: 'J’ai mal à la tête.' },

  // B1
  { level: 'B1', topic: 'Công việc', prompt: 'Tôi làm việc từ thứ Hai đến thứ Sáu.', answer: 'Je travaille du lundi au vendredi.' },
  { level: 'B1', topic: 'Gia đình', prompt: 'Anh trai tôi sống ở Lyon.', answer: 'Mon frère habite à Lyon.' },
  { level: 'B1', topic: 'Cảm xúc', prompt: 'Hôm nay tôi hơi lo lắng.', answer: 'Aujourd’hui, je suis un peu inquiet.' },
  { level: 'B1', topic: 'Học tập', prompt: 'Tôi đang học tiếng Pháp mỗi ngày.', answer: 'J’apprends le français tous les jours.' },
  { level: 'B1', topic: 'Du lịch', prompt: 'Tôi muốn mua vé khứ hồi.', answer: 'Je voudrais acheter un billet aller-retour.' },

  // B2
  { level: 'B2', topic: 'Giao tiếp', prompt: 'Theo tôi, chúng ta nên bắt đầu sớm hơn.', answer: 'Selon moi, nous devrions commencer plus tôt.' },
  { level: 'B2', topic: 'Công nghệ', prompt: 'Ứng dụng này giúp tôi học hiệu quả hơn.', answer: 'Cette application m’aide à apprendre plus efficacement.' },
  { level: 'B2', topic: 'Công việc', prompt: 'Tôi cần trình bày kế hoạch một cách rõ ràng.', answer: 'Je dois présenter le plan de manière claire.' },

  // C1
  { level: 'C1', topic: 'Bình luận', prompt: 'Tuy nhiên, chúng ta cần cân nhắc rủi ro.', answer: 'Toutefois, nous devons considérer les risques.' },
  { level: 'C1', topic: 'Tư duy', prompt: 'Mặc dù vậy, tôi vẫn tin rằng điều đó khả thi.', answer: 'Néanmoins, je pense que c’est faisable.' },

  // C2
  { level: 'C2', topic: 'Phân tích', prompt: 'Kể từ đó, mọi thứ đã thay đổi hoàn toàn.', answer: 'Dès lors, tout a complètement changé.' },
  { level: 'C2', topic: 'Trình bày', prompt: 'Dù sao đi nữa, chúng ta phải đưa ra quyết định.', answer: 'Quoi qu’il en soit, nous devons prendre une décision.' }
];
...
const speakingTasks = [
  ...
  { level: 'A1', topic: 'Chào hỏi', prompt: 'Je m’appelle Nam.', expected: 'Je m’appelle Nam.' },
  { level: 'A1', topic: 'Ẩm thực', prompt: 'Je veux un verre d’eau.', expected: 'Je veux un verre d’eau.' },
  { level: 'A1', topic: 'Gia đình', prompt: 'Voici ma famille.', expected: 'Voici ma famille.' },
  { level: 'A1', topic: 'Học tập', prompt: 'J’aime apprendre le français.', expected: 'J’aime apprendre le français.' },

  // A2
  { level: 'A2', topic: 'Du lịch', prompt: 'Où est la gare, s’il vous plaît ?', expected: 'Où est la gare, s’il vous plaît ?' },
  { level: 'A2', topic: 'Mua sắm', prompt: 'Aujourd’hui, je vais au marché.', expected: 'Aujourd’hui, je vais au marché.' },
  { level: 'A2', topic: 'Giao tiếp', prompt: 'Pouvez-vous répéter, s’il vous plaît ?', expected: 'Pouvez-vous répéter, s’il vous plaît ?' },
  { level: 'A2', topic: 'Sức khỏe', prompt: 'Je ne me sens pas très bien.', expected: 'Je ne me sens pas très bien.' },

  // B1
  { level: 'B1', topic: 'Công việc', prompt: 'Je travaille du lundi au vendredi.', expected: 'Je travaille du lundi au vendredi.' },
  { level: 'B1', topic: 'Cảm xúc', prompt: 'Je suis heureux aujourd’hui.', expected: 'Je suis heureux aujourd’hui.' },
  { level: 'B1', topic: 'Học tập', prompt: 'J’étudie le français chaque jour.', expected: 'J’étudie le français chaque jour.' },

  // B2+
  { level: 'B2', topic: 'Giao tiếp', prompt: 'Selon moi, c’est une bonne idée.', expected: 'Selon moi, c’est une bonne idée.' },
  { level: 'C1', topic: 'Bình luận', prompt: 'Toutefois, il faut être prudent.', expected: 'Toutefois, il faut être prudent.' },
  { level: 'C2', topic: 'Trình bày', prompt: 'Quoi qu’il en soit, je viendrai.', expected: 'Quoi qu’il en soit, je viendrai.' }
];

const pronunciationTasks = [
  { level: 'A1', topic: 'Chào hỏi', phrase: 'Bonjour, comment ça va ?' },
  { level: 'A1', topic: 'Ẩm thực', phrase: 'Je voudrais un café, s’il vous plaît.' },
  { level: 'A1', topic: 'Mua sắm', phrase: 'C’est combien ?' },
  { level: 'A1', topic: 'Gia đình', phrase: 'J’ai deux sœurs et un frère.' },
  { level: 'A2', topic: 'Du lịch', phrase: 'Où sont les toilettes ?' },
  { level: 'A2', topic: 'Du lịch', phrase: 'Je voudrais un billet pour Paris.' },
  { level: 'A2', topic: 'Giao tiếp', phrase: 'Je ne parle pas très bien français.' },
  { level: 'A2', topic: 'Giao tiếp', phrase: 'Pouvez-vous répéter, s’il vous plaît ?' },
  { level: 'B1', topic: 'Công việc', phrase: 'Je travaille dans une entreprise internationale.' },
  { level: 'B1', topic: 'Cảm xúc', phrase: 'Je suis un peu stressé aujourd’hui.' },
  { level: 'B2', topic: 'Công nghệ', phrase: 'Cette application est vraiment pratique.' },
  { level: 'C1', topic: 'Bình luận', phrase: 'Toutefois, nous devons rester réalistes.' }
];
...
const dialogueTasks = [
  ...
  },
  {
    ...
    topic: 'Chào hỏi',
    lines: [
      { speaker: 'A', fr: 'Salut ! Tu t’appelles comment ?', vi: 'Chào! Bạn tên là gì?' },
      { speaker: 'B', fr: 'Je m’appelle Linh. Et toi ?', vi: 'Mình tên Linh. Còn bạn?' },
      { speaker: 'A', fr: 'Moi, c’est Nam. Enchanté !', vi: 'Mình là Nam. Rất vui được gặp bạn!' }
    ]
  },
  {
    ...
    topic: 'Mua sắm',
    lines: [
      { speaker: 'Nhân viên', fr: 'Vous cherchez une taille particulière ?', vi: 'Anh/chị tìm cỡ nào ạ?' },
      { speaker: 'Khách', fr: 'Oui, je cherche une taille M.', vi: 'Vâng, tôi tìm cỡ M.' },
      { speaker: 'Nhân viên', fr: 'Voici. Vous voulez l’essayer ?', vi: 'Đây ạ. Anh/chị muốn thử không?' }
    ]
  },
  {
    title: 'Hỏi đường',
    ...
    topic: 'Du lịch',
    lines: [
      { speaker: 'Khách', fr: 'Excusez-moi, où est le musée ?', vi: 'Xin lỗi, bảo tàng ở đâu ạ?' },
      { speaker: 'Người dân', fr: 'Allez tout droit, puis tournez à gauche.', vi: 'Đi thẳng rồi rẽ trái.' },
      { speaker: 'Khách', fr: 'Merci beaucoup !', vi: 'Cảm ơn nhiều!' }
    ]
  },
  {
    title: 'Ở công ty',
    ...
    topic: 'Công việc',
    lines: [
      { speaker: 'Quản lý', fr: 'Tu peux finir le rapport avant 17h ?', vi: 'Em có thể xong báo cáo trước 5h không?' },
      { speaker: 'Nhân viên', fr: 'Oui, je le termine cet après-midi.', vi: 'Dạ được, em sẽ hoàn thành chiều nay.' },
      { speaker: 'Quản lý', fr: 'Parfait, merci.', vi: 'Tốt, cảm ơn.' }
    ]
  },
  {
    title: 'Thảo luận ý kiến',
    level: 'B2',
    topic: 'Giao tiếp',
    lines: [
      { speaker: 'A', fr: 'Selon moi, on devrait commencer plus tôt.', vi: 'Theo mình, chúng ta nên bắt đầu sớm hơn.' },
      { speaker: 'B', fr: 'Je suis d’accord, ce sera plus efficace.', vi: 'Mình đồng ý, như vậy sẽ hiệu quả hơn.' }
    ]
  }
];
...
let selectedPracticeLevel = 'all';
let selectedPracticeTopic = 'all';
let selectedPracticeOrder = 'easy';
let currentPracticeTab = 'translate';
let practiceFiltersByTab = null;
...
function setTaskMeta(element, task) {
  if (!element) return;
  const pieces = [];
  if (task && task.topic) pieces.push(`Chủ đề: ${task.topic}`);
  if (task && task.level) pieces.push(`Level: ${task.level}`);
  element.textContent = pieces.join(' • ');
  element.style.display = pieces.length ? 'inline-flex' : 'none';
}

function readPracticeFilters() {
  const fallback = {
    translate: { level: 'all', topic: 'all', order: 'easy' },
    speaking: { level: 'all', topic: 'all', order: 'easy' },
    pronunciation: { level: 'all', topic: 'all', order: 'easy' },
    dialogue: { level: 'all', topic: 'all', order: 'easy' }
  };
  const stored = readStorage('frenchCoachPracticeFilters', fallback);
  return { ...fallback, ...(stored || {}) };
}

function savePracticeFilters() {
  if (!practiceFiltersByTab) return;
  localStorage.setItem('frenchCoachPracticeFilters', JSON.stringify(practiceFiltersByTab));
  queueCloudSync();
}
...
function getTaskListForTab(tab) {
  if (tab === 'speaking') return speakingTasks;
  if (tab === 'pronunciation') return pronunciationTasks;
  if (tab === 'dialogue') return dialogueTasks;
  return practiceTasks;
}

function getPracticeTopicsForTab(tab) {
  const items = getTaskListForTab(tab);
  const topics = [...new Set(items.map(item => item.topic).filter(Boolean))].sort((a, b) => a.localeCompare(b, 'vi'));
  return ['all', ...topics];
}

function getPracticeLevelsForTab(tab) {
  const items = getTaskListForTab(tab);
  const levels = [...new Set(items.map(item => item.level).filter(Boolean))];
  levels.sort((a, b) => cefrLevels.indexOf(a) - cefrLevels.indexOf(b));
  return ['all', ...levels];
}

function applyPracticeFilters(items) {
  const filtered = items.filter(item => {
    const matchLevel = selectedPracticeLevel === 'all' || item.level === selectedPracticeLevel;
    const matchTopic = selectedPracticeTopic === 'all' || item.topic === selectedPracticeTopic;
    return matchLevel && matchTopic;
  });
  filtered.sort((a, b) => {
    const aIndex = cefrLevels.indexOf(a.level || 'A1');
    const bIndex = cefrLevels.indexOf(b.level || 'A1');
    return selectedPracticeOrder === 'hard' ? bIndex - aIndex : aIndex - bIndex;
  });
  return filtered;
}

function syncPracticeFilterStateFromTab() {
  if (!practiceFiltersByTab) practiceFiltersByTab = readPracticeFilters();
  const current = practiceFiltersByTab[currentPracticeTab] || { level: 'all', topic: 'all', order: 'easy' };
  selectedPracticeLevel = current.level || 'all';
  selectedPracticeTopic = current.topic || 'all';
  selectedPracticeOrder = current.order || 'easy';
}

function ensureFilterValueExists(options, value) {
  return options.includes(value) ? value : 'all';
}

function updatePracticeFilterControlsForTab() {
  if (!practiceFiltersByTab) practiceFiltersByTab = readPracticeFilters();
  syncPracticeFilterStateFromTab();

  const levelOptions = getPracticeLevelsForTab(currentPracticeTab);
  const topicOptions = getPracticeTopicsForTab(currentPracticeTab);

  selectedPracticeLevel = ensureFilterValueExists(levelOptions, selectedPracticeLevel);
  selectedPracticeTopic = ensureFilterValueExists(topicOptions, selectedPracticeTopic);

  practiceFiltersByTab[currentPracticeTab] = {
    level: selectedPracticeLevel,
    topic: selectedPracticeTopic,
    order: selectedPracticeOrder
  };
  savePracticeFilters();

  const levels = levelOptions.map(level => ({ value: level, label: level === 'all' ? 'Tất cả mức độ' : level }));
  const topics = topicOptions.map(topic => ({ value: topic, label: topic === 'all' ? 'Tất cả chủ đề' : topic }));
  buildSelectOptions(practiceLevelFilter, levels, selectedPracticeLevel);
  buildSelectOptions(practiceTopicFilter, topics, selectedPracticeTopic);
  if (practiceOrderFilter) practiceOrderFilter.value = selectedPracticeOrder;
}

function initPracticeFilters() {
  practiceFiltersByTab = readPracticeFilters();
  currentPracticeTab = 'translate';
  updatePracticeFilterControlsForTab();

  const handleChange = () => {
    selectedPracticeLevel = practiceLevelFilter ? practiceLevelFilter.value : 'all';
    selectedPracticeTopic = practiceTopicFilter ? practiceTopicFilter.value : 'all';
    selectedPracticeOrder = practiceOrderFilter ? practiceOrderFilter.value : 'easy';
    practiceFiltersByTab[currentPracticeTab] = {
      level: selectedPracticeLevel,
      topic: selectedPracticeTopic,
      order: selectedPracticeOrder
  ...
  if (practiceLevelFilter) practiceLevelFilter.addEventListener('change', handleChange);
  if (practiceTopicFilter) practiceTopicFilter.addEventListener('change', handleChange);
  if (practiceOrderFilter) practiceOrderFilter.addEventListener('change', handleChange);
}

function setEmptyPracticeState(metaEl, messageEl, message, controls = []) {
  setTaskMeta(metaEl, null);
...
function renderPractice() {
  const list = applyPracticeFilters(practiceTasks);
  if (!list.length) {
    setEmptyPracticeState(practiceMeta, practicePrompt, 'Không có câu dịch phù hợp với bộ lọc hiện tại.', [checkAnswer, nextPrompt]);
    if (practiceAnswer) practiceAnswer.value = '';
    if (practiceFeedback) practiceFeedback.textContent = '';
    return;
  }
  if (activePractice >= list.length) activePractice = 0;
  const task = list[activePractice];
  setTaskMeta(practiceMeta, task);
  practicePrompt.textContent = task.prompt;
  practiceAnswer.value = '';
  practiceFeedback.textContent = '';
  if (checkAnswer) checkAnswer.disabled = false;
  if (nextPrompt) nextPrompt.disabled = false;
}

function renderSpeaking() {
  const list = applyPracticeFilters(speakingTasks);
  if (!list.length) {
    setEmptyPracticeState(speakingMeta, speakingPrompt, 'Không có câu luyện nói phù hợp với bộ lọc hiện tại.', [startSpeaking, nextSpeaking]);
    if (speakingRecognized) speakingRecognized.textContent = '';
    if (speakingFeedback) speakingFeedback.textContent = '';
    return;
  }
  if (activeSpeaking >= list.length) activeSpeaking = 0;
  const task = list[activeSpeaking];
  setTaskMeta(speakingMeta, task);
  speakingPrompt.textContent = task.prompt;
  speakingRecognized.textContent = '';
  speakingFeedback.textContent = '';
  if (startSpeaking) startSpeaking.disabled = false;
  if (nextSpeaking) nextSpeaking.disabled = false;
}

function renderPronunciation() {
  const list = applyPracticeFilters(pronunciationTasks);
  if (!list.length) {
    setEmptyPracticeState(pronunciationMeta, pronunciationPrompt, 'Không có câu phát âm phù hợp với bộ lọc hiện tại.', [playPronunciationPhrase, startPronunciation, nextPronunciation]);
    if (pronunciationRecognized) pronunciationRecognized.textContent = '';
    if (pronunciationFeedback) pronunciationFeedback.textContent = '';
    return;
  }
  if (activePronunciation >= list.length) activePronunciation = 0;
  const task = list[activePronunciation];
  setTaskMeta(pronunciationMeta, task);
  pronunciationPrompt.textContent = task.phrase;
  pronunciationRecognized.textContent = '';
  pronunciationFeedback.textContent = '';
  if (playPronunciationPhrase) playPronunciationPhrase.disabled = false;
  if (startPronunciation) startPronunciation.disabled = false;
  if (nextPronunciation) nextPronunciation.disabled = false;
}

function renderDialogue() {
  const list = applyPracticeFilters(dialogueTasks);
  if (!list.length) {
    setEmptyPracticeState(dialogueMeta, dialogueTitle, 'Không có hội thoại phù hợp với bộ lọc hiện tại.', [toggleDialogueTranslation, nextDialogue, speakDialogueLine]);
    if (dialogueText) dialogueText.innerHTML = '';
    return;
  }
  if (activeDialogue >= list.length) activeDialogue = 0;
  const task = list[activeDialogue];
  setTaskMeta(dialogueMeta, task);
  ...
  `).join('');
  if (toggleDialogueTranslation) toggleDialogueTranslation.disabled = false;
  if (nextDialogue) nextDialogue.disabled = false;
  if (speakDialogueLine) speakDialogueLine.disabled = false;
}
...
function switchPracticeTab(tab) {
  ...
  if (tab === 'translate') renderPractice();
  if (tab === 'speaking') renderSpeaking();
  if (tab === 'pronunciation') renderPronunciation();
  if (tab === 'dialogue') renderDialogue();
}
...
function loadVoiceSetting() {
  selectedVoiceName = localStorage.getItem('frenchCoachVoice') || '';
}

function saveVoiceSetting(name) {
  selectedVoiceName = name || '';
  localStorage.setItem('frenchCoachVoice', selectedVoiceName);
  queueCloudSync();
}
...
function getFrenchVoices() {
  ...
  french.sort((a, b) => (a.lang || '').localeCompare(b.lang || '') || (a.name || '').localeCompare(b.name || ''));
  return french;
}

function pickPreferredFrenchVoiceName(voices) {
  if (!voices || !voices.length) return '';
  const byName = (needle) => voices.find(v => (v.name || '').toLowerCase().includes(needle));
  // Ưu tiên giọng Google nếu trình duyệt có (thường thấy trên Chrome: "Google français")
  const google = byName('google');
  if (google) return google.name;
  // Nếu không có Google, ưu tiên giọng tự nhiên của Microsoft (Edge/Windows) nếu có
  const msNatural = voices.find(v => /(microsoft).*(natural|online)/i.test(v.name || ''));
  if (msNatural) return msNatural.name;
  const microsoft = byName('microsoft');
  if (microsoft) return microsoft.name;
...
function populateVoiceSelect() {
  ...
  const options = [{ value: '', label: 'Tự động (mặc định)' }]
    .concat(voices.map(v => ({ value: v.name, label: `${v.name} (${v.lang})` })));
  voiceSelect.innerHTML = options.map(opt => `<option value="${opt.value}">${opt.label}</option>`).join('');
  voiceSelect.value = options.some(opt => opt.value === selectedVoiceName) ? selectedVoiceName : '';
}
...
function initVoiceSelect() {
  ...
  populateVoiceSelect();
  const tryAutoPick = () => {
    // Nếu user chưa chọn, tự chọn giọng ưu tiên (Google nếu có)
    if (!selectedVoiceName) {
      const voices = getFrenchVoices();
      const preferred = pickPreferredFrenchVoiceName(voices);
      if (preferred) saveVoiceSetting(preferred);
    }
    populateVoiceSelect();
  };
  tryAutoPick();
  if (window.speechSynthesis && typeof speechSynthesis.addEventListener === 'function') {
    speechSynthesis.addEventListener('voiceschanged', tryAutoPick);
  }
  if (voiceSelect) {
    voiceSelect.addEventListener('change', () => saveVoiceSetting(voiceSelect.value));
  }
  if (testVoice) {
    testVoice.addEventListener('click', () => speak('Bonjour, je m’appelle FrenchCoach.'));
  }
}
...
function speak(text) {
  ...
  const voices = getFrenchVoices();
  const selected = selectedVoiceName && voices.find(v => v.name === selectedVoiceName);
...
nextSpeaking.addEventListener('click', () => {
  const list = applyPracticeFilters(speakingTasks);
  if (!list.length) return;
  activeSpeaking = (activeSpeaking + 1) % list.length;
  renderSpeaking();
});
...
nextPronunciation.addEventListener('click', () => {
  const list = applyPracticeFilters(pronunciationTasks);
  if (!list.length) return;
  activePronunciation = (activePronunciation + 1) % list.length;
  renderPronunciation();
});
...
nextDialogue.addEventListener('click', () => {
  const list = applyPracticeFilters(dialogueTasks);
  if (!list.length) return;
  activeDialogue = (activeDialogue + 1) % list.length;
  renderDialogue();
});
...
nextPrompt.addEventListener('click', () => {
  const list = applyPracticeFilters(practiceTasks);
  if (!list.length) return;
  activePractice = (activePractice + 1) % list.length;
  renderPractice();
});
